...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //,-----------------------------------------------------.                    ,-----------------------------------------------------.
      ...
      LCTL(KC_CAPS), KC_A, KC_S,   KC_D,      KC_F,   KC_G,                    KC_H,   KC_J,    KC_K,    KC_L,    KC_SCLN,   KCL_QUOTL,\
  ...
  //,-----------------------------------------------------.                    ,-----------------------------------------------------.
      ...
      LCTL(LGUI(KC_LEFT)), LCTL(LGUI(KC_RIGHT)), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,   KC_MPLY, KC_MUTE, KC_VOLD, KC_VOLU, \
